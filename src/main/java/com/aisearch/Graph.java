...
public class Graph extends Panel {
    ...
    public void loadGraph(String configuracion) throws Exception {
        ...
        numNodos = entrada.open(configuracion);
            ...
            while (Step < 4) {
                switch (Step) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        Graph.this.NodoObjetivo = miObjetivo;
                        Graph.this.paintGrafo();
                }
    ...
    public class BF {
        ...
        private void reordenar(List<String> vector) {
